...
namespace AdimeoDataSuite\SearchClientBundle\Controller;

use AdimeoDataSuite\SearchClientBundle\Classes\SearchContext;
...
class SearchController extends Controller
{
  ...
  private function getSearchPageDefinition(Request $request, $id){
    $client = new Client();
    $response = $client->request('GET', $request->getSchemeAndHttpHost() . $request->getBaseUrl() . '/api/sp-definition/' . $id);
